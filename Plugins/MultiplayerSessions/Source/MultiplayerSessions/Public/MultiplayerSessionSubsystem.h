...
//
// Declaring our own custom delegates for the Menu class to vind callbacks to 
//
...
public:
	...
	//Custom delegates for the Menu class to bind callboacks to
...
protected:
	...
	// Those don't need to be called outside the class.
	//
